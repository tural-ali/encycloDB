...
CREATE TABLE `ProfessionTranslation` (
  `profession_id` int(5) unsigned NOT NULL,
  `language` char(2) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`profession_id`,`language`),
  CONSTRAINT `professiontranslation_ibfk_1` FOREIGN KEY (`profession_id`) REFERENCES `Profession` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
